...
export default function SignupPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const res = await apiPost<any>("/auth/customer/signup", { name, email, password });
      localStorage.setItem("pending_email", email);
      if (res && (res as any).dev_code) {
        localStorage.setItem("pending_dev_code", String((res as any).dev_code));
      }
        ...
        <div className="pt-2 grid grid-cols-1 gap-2">
          <button
            ...
            onClick={async()=>{
              ...
              } else { alert("Google sign-up not configured"); }
            }}>
          ...
          <button
            ...
            onClick={async()=>{
              ...
              } else { alert("Facebook sign-up not configured"); }
            }}>
          ...
          <button
            ...
            onClick={async()=>{
              ...
              } else { alert("GitHub sign-up not configured"); }
            }}>
